...
public void OnSceneGUI()
{
    ...
    {
        // The field is [SerializeField] private: SerializedObject writes it and records the undo step
        serializedObject.Update();
        serializedObject.FindProperty("lookAtPoint").vector3Value = pos;
        serializedObject.ApplyModifiedProperties();
    }
}
```
...
public class MyToolWindow : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        rootVisualElement.Add(new Button(() => GameDebug.Log("Clicked!")) { text = "Click Me" });
    }
}
```
...
private static bool ValidateResetPosition() => Selection.activeTransform != null;
...
private static void CreateMyObject(MenuCommand menuCommand)
{
...
public class CircleLayoutEditor : Editor
{
    public void OnSceneGUI()
    {
        ...
        {
            serializedObject.Update();
            serializedObject.FindProperty("radius").floatValue = newRadius;
            serializedObject.ApplyModifiedProperties();
        }
    }
}
