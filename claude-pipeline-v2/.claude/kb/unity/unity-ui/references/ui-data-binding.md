...
public class PercentageBar : BindableElement, INotifyValueChanged<float>
{
    ...
    public void SetValueWithoutNotify(float newValue)
    {
        ...
        _fillBar.style.width = Length.Percent(_value * 100f);
        _valueLabel.text = $"{_value:P0}";
    }
    ...
    public PercentageBar()
    {
        ...
        _fillBar.AddToClassList("percentage-bar__fill");
        Add(_fillBar);

        _valueLabel = new Label("0%");
        _valueLabel.AddToClassList("percentage-bar__label");
        Add(_valueLabel);
    }
}
```
...
public class GameHUD : MonoBehaviour
{
    ...
    {
        var root = uiDocument.rootVisualElement;
        root.Q<Label>("score-label").text = $"Score: {_gameState.Score}";
        root.Q<ProgressBar>("health-bar").value = _gameState.Health;
    }
    ...
    {
        _gameState.Health = Mathf.Max(0, _gameState.Health - damage);
    }
}
```
