...
bool isSupported = AudioSource.GamepadSpeakerSupportsOutputType(outputType);
```
...
public class ProceduralAudio : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        AudioClip clip = AudioClip.Create(
            "SineWave", _sampleRate * 2, 1, _sampleRate, true,
...
bool isSet = mixer.SetFloat("MasterVolume", -10f); // value in dB

// Get an exposed parameter value
// Returns false if the parameter name doesn't exist
float value;
bool hasParameter = mixer.GetFloat("MasterVolume", out value);
