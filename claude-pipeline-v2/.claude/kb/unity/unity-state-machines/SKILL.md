...
public class IdleState : IState
{
    ...
    private bool _shouldTransitionToChase;

    public bool ShouldTransitionToChase => _shouldTransitionToChase;

    public IdleState(EnemyContext ctx) => _ctx = ctx;

    public void Enter() => _shouldTransitionToChase = false;

    public void Tick(float deltaTime)
    {
        if (_ctx.DistanceToPlayer < _ctx.DetectionRange)
            _shouldTransitionToChase = true;
    }
