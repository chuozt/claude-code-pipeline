...
public class EnemyAI : MonoBehaviour
{
    ...
    private void OnEnable() => _fsm.ChangeState<IdleState>();
...
public class IdleState : IState
{
    ...
    public IdleState(EnemyContext ctx, StateMachine fsm)
    {
        _ctx = ctx;
        _fsm = fsm;
    }
...
public class ChaseState : IState
{
    ...
    public ChaseState(EnemyContext ctx, StateMachine fsm)
    {
        _ctx = ctx;
        _fsm = fsm;
    }
...
public class StateStack
{
    ...
    public void Push(IStackableState state)
    {
        ...
        {
            GameDebug.LogWarning($"StateStack at max depth ({MaxDepth}). Push ignored.");
            return;
        }
