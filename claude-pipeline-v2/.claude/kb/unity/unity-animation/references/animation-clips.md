...
private void Update()
{
    float attackPower = _animator.GetFloat("AttackPower");
    _damageMultiplier = attackPower;
}
```
...
public class AnimationEventHandler : MonoBehaviour
{
    ...
    {
        _audioSource.PlayOneShot(attackWhoosh);
    }
    ...
    public void PlayFootstep(float volume)
    {
        if (footstepSounds.Length > 0)
        {
            ...
            _audioSource.PlayOneShot(footstepSounds[index], volume);
        }
    }
    ...
    {
        _weaponTrail.emitting = active == 1;
    }
