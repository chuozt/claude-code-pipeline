...
public class SimplePlayer : MonoBehaviour
{
    ...
    private static readonly int s_strafeHash = Animator.StringToHash("Strafe");
    private static readonly int s_fireHash = Animator.StringToHash("Fire");
    ...
    private void Update()
    {
        ...
        _animator.SetFloat(s_forwardHash, v, 0.1f, Time.deltaTime);
        _animator.SetFloat(s_strafeHash, h, 0.1f, Time.deltaTime);
        _animator.SetBool(s_fireHash, isFiring);
    }
...
public class CharacterSkinSwap : MonoBehaviour
{
    ...
    {
        _animator.runtimeAnimatorController = characterOverrides[index];
