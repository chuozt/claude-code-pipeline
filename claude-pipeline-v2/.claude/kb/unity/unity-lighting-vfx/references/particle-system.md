...
public class ParticleCollisionHandler : MonoBehaviour
{
    ...
    {
        int numCollisions = _ps.GetCollisionEvents(other, _collisionEvents);
...
public class SubEmitterSetup : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem deathSubEmitter;
...
public class ParticleManipulator : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Vector3 toTarget = transform.position - _particles[i].position;
            _particles[i].velocity += toTarget.normalized * Time.deltaTime * 5f;
        }
