...
public class BulletSpawner : MonoBehaviour
{
    ...
    public void ReturnBullet(GameObject bullet) => _pool.Release(bullet);
}
```
...
private void Awake()
{
    _vfxPool = new ObjectPool<ParticleSystem>(
        createFunc: () =>
        {
...
private void OnParticleSystemStopped() => _vfxPool.Release(GetComponent<ParticleSystem>());
```
...
private void ProcessNearbyEnemies()
{
