...
```csharp
[SerializeField] private float speed = 5f;         // Serialize private field
...
public class AsyncExample : MonoBehaviour
{
    ...
    private async Awaitable LoadAndProcessAsync(CancellationToken token)
    {
