...
GameDebug.Log(enemies.Count); // Count is correct, but enemy is "alive" until end of frame
...
public class LookAtTarget : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Safety: references may not exist in edit mode
        if (!target)
            return;
...
static void Initialize()
{
    ...
    GameDebug.Log("This runs AFTER Awake, not before");
}
```
