---
name: lib-textmeshpro
model: claude-opus-5-5
effort: medium
description: "TextMeshPro reference — font assets and fallback, material presets, rich-text tags, sprite assets inside text, dynamic atlases. Use when working on any text rendering, or saying 'font missing glyph', 'TMP material', 'rich text', 'sprite in text'."
---
...
public class LinkHandler : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (linkIndex >= 0)
        {
            ...
            GameDebug.Log($"Clicked link: {linkId} ({linkText})");
            HandleLink(linkId);
        }
    }
