---
name: gd-playtest-protocol
description: "Plan a playtest BEFORE it runs, so it produces actionable data rather than 'it was fun': objectives, observation checklist, questionnaire, which playtest type (blind, facilitated, A/B), what to measure and how to read it. Writing up the results afterwards is /playtest-report. Use when typing /gd-playtest-protocol or saying 'plan a playtest', 'what should we ask testers', 'design a playtest'."
---
