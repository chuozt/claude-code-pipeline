...
effort: medium
description: "DOTween reference — sequences, tween lifecycle, easing, kill strategies, linking tweens to GameObjects. Use when writing or reviewing DOTween code, or saying 'tween this', 'DOTween sequence', 'tween not killed'. Always kill tweens in OnDisable/OnDestroy."
---
...
seq.AppendCallback(() => GameDebug.Log("Done!"));
...
transform.DOMove(target, 1f)
    ...
    .OnUpdate(() => GameDebug.Log("Updating"))
    .OnComplete(() => GameDebug.Log("Done"))
    .OnKill(() => GameDebug.Log("Killed"))
    .OnStepComplete(() => GameDebug.Log("Loop step done"));
```
