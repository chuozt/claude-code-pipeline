---
name: design-review
description: "Review ONE design document in depth: all 8 required sections present, internally consistent, implementable, testable acceptance criteria. Run before handing a GDD to programmers. Checking several documents against each other is /consistency-check (numbers) or /review-all-gdds (the whole set). Use when typing /design-review or saying 'review this GDD', 'is this design doc ready', 'check this spec'."
