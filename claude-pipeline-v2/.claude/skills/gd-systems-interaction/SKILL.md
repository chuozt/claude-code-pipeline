---
name: gd-systems-interaction
description: "Map how the game's systems affect each other — mechanics, boosters, economy, progression — to find feedback loops (reinforcing, balancing, broken), exploit paths and degenerate strategies before they ship, and predict what a change in one system does to the others. Use when typing /gd-systems-interaction or saying 'how do these systems interact', 'will adding this break something', 'why did changing X affect Y'."
---
