...
- **Design changes:** "Run `/consistency-check` to find the other design documents that depend on the values being changed, before changing them."
...
- After fixing bugs: re-prioritise the remaining list with the team.
