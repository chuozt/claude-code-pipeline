...
effort: medium
description: "Write the missing design or architecture document for something that already exists in code or a prototype, working backwards from the implementation. Use when typing /reverse-document or saying 'document what we built', 'write the GDD for this existing feature', 'there is no doc for this'."
