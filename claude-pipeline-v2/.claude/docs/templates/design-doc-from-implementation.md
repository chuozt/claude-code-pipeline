...
- Run the balance check step on [specific aspect]
...
- [ ] **Balance pass**: Run the balance check step on progression curve
...
**Related Skills**:
- the balance check step — Validate formulas and progression
- `/architecture-decision` — Document technical decisions
- the code review step — Ensure code matches clarified design
