...
effort: medium
description: "UniTask reference — zero-alloc async/await, cancellation tokens tied to object lifetime, PlayerLoop timing, WhenAll/WhenAny. Use when writing or reviewing async code, or saying 'await this', 'cancel on destroy', 'UniTask vs coroutine'."
---
...
public class SimpleAsync : MonoBehaviour
{
    private async UniTaskVoid Start()
    {
        ...
        GameDebug.Log("This won't run if object was destroyed");
    }
}
```
...
public async UniTask LoadDataAsync(CancellationToken ct)
{
    ...
    catch (Exception ex)
    {
        ...
        GameDebug.LogError(ex.ToString());
    }
}
```
...
public class GameBootstrap : MonoBehaviour
{
    private async UniTaskVoid Start()
    {
        ...
        {
            GameDebug.Log("Bootstrap cancelled");
        }
        catch (Exception ex)
        {
            GameDebug.LogError(ex.ToString());
