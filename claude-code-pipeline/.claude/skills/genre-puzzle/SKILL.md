...
effort: medium
description: "Architecture patterns for mobile puzzle games — grid/board model, undo, hints, level packs, star ratings, touch drag-and-drop, tutorial overlays. Use when building one of these systems or asking how the board, undo or hint system should be structured."
---
