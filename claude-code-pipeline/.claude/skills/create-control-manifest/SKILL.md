...
this date when created. Downstream work compares its embedded version
...
- If epics/stories don't exist yet: "Programmers can now use this manifest when they write implementation notes for each
  task."
