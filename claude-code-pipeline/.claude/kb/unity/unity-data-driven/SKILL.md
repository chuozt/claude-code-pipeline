...
public class EnemyConfig : ScriptableObject
{
    ...
    [Range(0f, 20f)] [SerializeField] private float moveSpeed = 5f;
    [Range(0f, 50f)] [SerializeField] private float attackDamage = 10f;

    [Header("AI")]
    [Range(1f, 50f)] [SerializeField] private float detectionRange = 15f;
    [Range(0.5f, 5f)] [SerializeField] private float attackCooldown = 1.5f;

    [Header("Rewards")]
    [Tooltip("Loot dropped on death. Leave empty for no loot.")]
    [SerializeField] private LootTable lootTable;
    [Min(0)] [SerializeField] private int xpReward = 25;
...
public class EnemyConfig : ScriptableObject
{
    ...
    [Header("Combat")]
    [SerializeField] private AttackConfig attack;
...
{
    [Range(0f, 50f)] [SerializeField] private float meleeDamage = 15f;
    [Range(0.5f, 3f)] [SerializeField] private float attackRadius = 1.5f;
}
...
public class RangedEnemyConfig : EnemyConfig
{
    ...
    [Range(0f, 50f)] [SerializeField] private float projectileDamage = 10f;
    [Range(5f, 30f)] [SerializeField] private float fireRange = 15f;
}
```
...
{
    private async Awaitable<WaveData[]> LoadWaves()
    {
...
public class WeaponConfig : ScriptableObject
{
    ...
    [Range(1f, 200f)] [SerializeField] private float baseDamage = 10f;

    [Tooltip("Seconds between attacks")]
    [Range(0.1f, 5f)] [SerializeField] private float attackSpeed = 1f;

    [Tooltip("Maximum range in world units")]
    [Range(0.5f, 30f)] [SerializeField] private float range = 2f;
    ...
    [SerializeField] private AnimationCurve damageFalloff = AnimationCurve.Linear(0, 1, 1, 0.5f);
}
```
