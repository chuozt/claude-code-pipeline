...
public static class GameSettings
{
    ...
    public static float MasterVolume
    {
        ...
        set
        {
            PlayerPrefs.SetFloat(Prefix + "masterVolume", value);
    ...
    public static int QualityLevel
    {
        ...
        set
        {
            PlayerPrefs.SetInt(Prefix + "quality", value);
            OnSettingsChanged?.Invoke();
        }
    }
...
public static class SaveMigrator
{
    ...
    private static void MigrateV1ToV2(Newtonsoft.Json.Linq.JObject data)
    {
        ...
        if (player != null && player["playerX"] != null)
        {
            ...
            player.Remove("playerX");
            player.Remove("playerY");
            player.Remove("playerZ");
        }
    }

    private static void MigrateV2ToV3(Newtonsoft.Json.Linq.JObject data)
    {
...
public class SaveManager : MonoBehaviour
{
    public async Awaitable Save(GameSaveData data)
    {
        ...
        {
            GameDebug.LogWarning($"Cloud save failed (local save preserved): {e.Message}");
        }
    }
}
```
...
public class AutoSaveManager : MonoBehaviour
{
    ...
    private async Awaitable PerformAutoSave()
    {
        ...
        {
            GameDebug.LogError($"Auto-save failed: {e.Message}");
        }
    }
