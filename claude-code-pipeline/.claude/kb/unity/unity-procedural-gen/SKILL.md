...
public class NoiseConfig : ScriptableObject
{
    ...
    [SerializeField, Range(0f, 100f)] private float amplitude = 10f;
    ...
    [SerializeField, Range(0f, 1f)] private float domainWarpStrength = 0f;
...
public class Grid<T>
{
    ...
    {
        get => _cells[coord.y * width + coord.x];
        set => _cells[coord.y * width + coord.x] = value;
    }
...
public class TileDefinition : ScriptableObject
{
    ...
    [SerializeField] private TileDefinition[] allowedNeighbors;

    public string TileName => tileName;
    public GameObject Prefab => prefab;
    public TileDefinition[] AllowedNeighbors => allowedNeighbors;
}
...
public class DungeonConfig : ScriptableObject
{
    ...
    [SerializeField, Range(6, 30)] private int maxRoomSize = 14;
    [SerializeField, Range(3, 20)] private int roomCountMin = 5;
    [SerializeField, Range(5, 30)] private int roomCountMax = 12;

    [Header("BSP")]
    [SerializeField, Range(2, 8)] private int splitDepth = 4;
...
public class ContentPlacer
{
    ...
    private List<(ContentEntry item, float weight)> BuildWeightedList(ContentBudget budget)
    {
        ...
        foreach (var entry in budget.Entries)
        {
            int placed = _placedCounts.GetValueOrDefault(entry.category);
    ...
    {
        _placedCounts.TryGetValue(category, out int count);
        _placedCounts[category] = count + 1;
    }
}
```
