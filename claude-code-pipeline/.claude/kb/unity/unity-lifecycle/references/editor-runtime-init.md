...
public class AudioManager : MonoBehaviour
{
    ...
    [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]
    static void ResetStatic() => s_instance = null;
...
void OnValidate()
{
    ...
    if (_targetPrefab != null
        && _targetPrefab.GetComponent<Rigidbody>() == null)
        GameDebug.LogWarning("Target prefab is missing Rigidbody", this);
}
#endif
```
