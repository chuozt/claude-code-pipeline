...
public void LogWarning_IsExpected()
{
    ...
    GameDebug.LogWarning("Expected warning message");
}
```
...
{
    private bool _wasPlaySoundCalled;

    public bool PlaySoundCalled => _wasPlaySoundCalled;

    public void PlaySound(string name) => _wasPlaySoundCalled = true;
}
