...
// Guard against zero/near-zero vector
...
// A false return means the ray points away from the plane (enter is negative)
...
bool isInside = (closest - point).sqrMagnitude < 0.0001f;
...
bool isInsideLocal = localBounds.Contains(localPoint);
```
