...
bool isAbovePlane = plane.GetSide(point);           // true = same side as normal
...
bool isOverlapping = a.Intersects(b);

// Point containment
bool isContained = a.Contains(point);
...
// Ray intersection
float enter;
bool isHit = a.IntersectRay(ray, out enter);
...
bool isInFov = dot > Mathf.Cos(halfFovRadians); // cos(45deg) = 0.707 for 90-degree FOV
