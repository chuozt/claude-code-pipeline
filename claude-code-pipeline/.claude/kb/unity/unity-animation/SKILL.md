...
public class PlayerAnimController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        _animator.SetBool("Fire", isFiring);
    }
...
private void Update()
{
    ...
    float direction = Vector3.SignedAngle(transform.forward,
        _rb.velocity.normalized, Vector3.up);

    _animator.SetFloat("Speed", speed, 0.1f, Time.deltaTime);
    _animator.SetFloat("Direction", direction, 0.1f, Time.deltaTime);
}
```
...
public class RootMotionController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _animator.applyRootMotion = false; // We handle it manually
    }
...
if (stateInfo.IsName("Attack"))
    GameDebug.Log("Currently attacking");

if (stateInfo.normalizedTime >= 1.0f
    && !animator.IsInTransition(0))
    GameDebug.Log("Animation finished");
...
public class LocomotionController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        _animator.SetFloat(s_speedHash, Mathf.Abs(speed), 0.1f, Time.deltaTime);
