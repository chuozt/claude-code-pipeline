...
| Start exaggerated, tune down | The `/gd-feel` skill applies this — values are always dialed back from a bold starting point |
| Feel questions asked upfront | Step 3 of the implementation workflow in `.claude/workflow.md` — never defer feel to Phase 5 |
