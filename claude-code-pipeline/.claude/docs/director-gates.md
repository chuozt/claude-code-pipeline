...
| `lean` | PHASE-GATEs only (the gate check step) — per-skill gates skipped | **Default** — solo devs and small teams; directors review at milestones only |
...
**Trigger**: Always at the gate check step — spawn in parallel with TD-PHASE-GATE and PR-PHASE-GATE
...
**Trigger**: Always at the gate check step — spawn in parallel with CD-PHASE-GATE and PR-PHASE-GATE
...
**Trigger**: Before finalising a sprint plan (the sprint plan step), and after any
...
**Trigger**: At milestone review (the milestone review step), at mid-sprint retrospectives,
...
**Trigger**: After epics are defined by the create epics step, before stories are
broken out — validates the epic structure is producible before the create stories step
is invoked
...
**Trigger**: Always at the gate check step — spawn in parallel with CD-PHASE-GATE and TD-PHASE-GATE
...
**Trigger**: Always at the gate check step — spawn in parallel with CD-PHASE-GATE, TD-PHASE-GATE, and PR-PHASE-GATE
...
**Trigger**: After a dev story is implemented (the dev story step, the story done step), or
as part of the code review step
...
**Trigger**: Before a story is accepted into a sprint — invoked by the create stories step,
the story readiness step, and the sprint plan step during story selection
...
done, or at the gate check step Production → Polish
...
at the gate check step), spawn all agents simultaneously:
