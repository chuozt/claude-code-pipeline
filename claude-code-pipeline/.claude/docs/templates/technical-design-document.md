...
| **APIs Depended On** | [Specific classes/methods/nodes used, version-pinned — e.g. `Physics2D.OverlapPointNonAlloc()` (Unity 6)] |
| **References Consulted** | [docs read before writing this — e.g. `.claude/kb/unity/unity-physics/SKILL.md`, the Unity 6 manual page] |
