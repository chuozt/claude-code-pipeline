...
3. **Draft based on user's choice (incremental file writing):**
   ...
   - Update `docs/_session/active.md` after each section with:
...
- Make story decisions (coordinate with creative-director)
- Implement levels in the engine
- Set difficulty parameters for the whole game (only per-encounter)

### Reports to: `game-designer`
### Coordinates with: `creative-director`, `art-director`, `audio-director`
